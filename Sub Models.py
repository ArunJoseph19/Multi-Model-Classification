# -*- coding: utf-8 -*-
"""
Created on Fri Aug  7 16:27:29 2020
...
training_set = train_datagen.flow_from_directory('Dataset/training_set/Sloth V Croissant', #path to folder
...
#saving the model
cnn.save('Models/SlothVCroissant')
